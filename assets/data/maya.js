...
export const mayaSigns = [
    { ru: 'Орел (Мен)', en: 'blue_eagle', description: 'Ты обладаешь проницательностью и высоким летанием мысли. Твоя интуиция часто ведет тебя к успеху.',
        image: orel},
    { ru: 'Гриф (Киб)', en: 'yellow_warrior', description: 'Ты смелый и решительный, готовый бороться за свои идеалы. Твоя целеустремленность помогает тебе достигать поставленных целей.', image: grif },
    ...
    { ru: 'Зерно (Кан)', en: 'yellow_seed', description: 'Ты плодотворный и плодоносящий, как зерно в почве. Ты способен принести плоды своего труда и дарить жизнь новым идеям.', image: zerno },
    ...
    { ru: 'Лестница (Эб)', en: 'yellow_human', description: 'Ты человек, обладающий светлой и доброй натурой. Ты способен дарить тепло и свет другим своим присутствием.', image: lestnica},
    ...
    { ru: 'Ягуар (Иш)', en: 'white_wizard', description: 'Ты волшебник, обладающий магией и чудесами. Твоя мудрость и волшебство способны преобразовать мир вокруг тебя.', image: yaguar},
];